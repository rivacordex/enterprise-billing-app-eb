      ...
      const refunded = await refundPayment(
        {
          ...
          referenceDate: new Date("2026-05-02T00:00:00.000Z"),
      ...
      const allocated = await allocatePayment(
        {
          ...
          referenceDate: new Date("2026-05-04T00:00:00.000Z"),
      ...
      const tooMuch = await refundPayment(
        {
          ...
          referenceDate: new Date("2026-05-05T00:00:00.000Z"),
      ...
      const again = await refundPayment(
        {
          ...
          referenceDate: new Date("2026-05-06T00:00:00.000Z"),
      ...
      const captured = await capturePayment(
        {
          ...
          referenceDate: new Date("2026-05-07T00:00:00.000Z"),
      ...
      const allocated = await allocatePayment(
        {
          ...
          referenceDate: new Date("2026-05-08T00:00:00.000Z"),
      ...
      const result = await refundPayment(
        {
          ...
          referenceDate: new Date("2026-05-12T00:00:00.000Z"),
