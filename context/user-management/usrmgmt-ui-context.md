...
> **Not used in this module.** Architecture §7: User Management has **no AI/ML components**. The Iris/violet family and `--gradient-ai` below are defined for *later* modules (billing-anomaly flags, suggested roles, natural-language search) and must not appear on any v1 admin screen (see §0).
