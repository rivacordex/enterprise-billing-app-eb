...
**Status:** Planned — decisions D1–D13 locked in `_updatemodule-product-manage-page-refactor-plan.md` (2026-09-19)
**Companion docs:** `prodmgmt-architecture.md` (Module Invariants — five amendments pending design review), `prodmgmt-code-standards.md`, `prodmgmt-ui-context.md`, `bm29-real-aggregation-recurring-price-resolver.md` (recurring price consumer), `rm08-rp-price-resolution-snapshot.md` (usage price consumer)
