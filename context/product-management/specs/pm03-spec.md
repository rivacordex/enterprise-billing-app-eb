...
- **Dependencies:** pm02 (data layer: migration `0006_product`, `validation/product/` schemas, `types/product.ts` unions, `Demo — *` seeds) verified and merged. pm03 must not start before that (pm02 §3.9).
