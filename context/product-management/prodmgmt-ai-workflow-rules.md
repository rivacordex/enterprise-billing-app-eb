...
| **G-B** | §0.2 | pm46 — any schema, repository write or service. | **OPEN** |
| **G-C** | §0.3 | pm46 — opening `0006_product.sql`. | **OPEN** |
| **G-D** | §0.4 | Unit numbering. | **CLOSED** by `pm00-build-plan.md` (2026-09-21) |
| **G-E** | §0.6 | pm46–pm49 — the planned red-tree window. | **OPEN — unresolved conflict with the general doc** |
