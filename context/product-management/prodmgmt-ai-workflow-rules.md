...
- **Ordering update (shipped, pm25–pm34):** `prodmgmt-update-overview.md` (spec, scope, success criteria) and `_updatemodule-product-ordering-inventory-plan.md` (decisions Q1–Q20, tables, sample data) are the authorizing documents for that work — a unit extending the update cites them, not the catalog overview.
